...
export  class Worker extends User {
    ...
    async GetWorkerInformation(WorkerObject: Worker) {// fill workerObject with all information of the worker
        ...
        try {
          const response = await axios.post("http://192.168.100.9:3001/api/Worker/GetWorkerInformation",{ WorkerObject });//the object to send must be *WorkerObject*  
      ...
      async GetAllWorkers() {// Get All workers, even the premium workers
        ...
        try {
          const response = await axios.post("http://192.168.100.9:3001/api/Worker/GetAllWorkers",{ });//the object to send must be *WorkerObject*           
      ...
      async GetOnlyWorkers() {// Get All workers, even the premium workers
        ...
        try {
          const response = await axios.post("http://192.168.100.9:3001/api/Worker/GetOnlyWorkers",{ });//the object to send must be *WorkerObject*           
